...
class MainActivity : AppCompatActivity() {
    ...
    fun readMessage(reader: JsonReader): String {
        ...
        reader.endObject()
        if(desc == "Desert" && score >= .90){
            return "I'm not really a fan of the desert"
        }
        else if (desc == "Natural landscape" && score >= .90){
            return "Wow, what an awesome view"
        }
//        return "%.2f".format(score) + "\t $desc"
    ...
    companion object {
        ...
        private const val API_KEY = "enter google api key here"//your API Key should be placed here
    }
